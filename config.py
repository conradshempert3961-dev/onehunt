...
YOOMONEY_RETURN_URL = os.getenv("YOOMONEY_RETURN_URL", MINIAPP_URL or "https://t.me/Onehuntbot").strip()
YOOMONEY_LABEL_PREFIX = os.getenv("YOOMONEY_LABEL_PREFIX", "onehunt").strip() or "onehunt"
CRYPTO_PAY_API_TOKEN = os.getenv("CRYPTO_PAY_API_TOKEN", "").strip()
CRYPTO_PAY_API_BASE_URL = os.getenv("CRYPTO_PAY_API_BASE_URL", "https://pay.crypt.bot/api").rstrip("/")
CRYPTO_PAY_RETURN_URL = os.getenv("CRYPTO_PAY_RETURN_URL", MINIAPP_URL or "https://t.me/Onehuntbot").strip()
CRYPTO_PAY_ACCEPTED_ASSETS = os.getenv("CRYPTO_PAY_ACCEPTED_ASSETS", "TON,USDT").strip()
